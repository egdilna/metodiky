---
layout: default
title: Kontrolní seznam pro evidenci datových potřeb úřadu
description: "Tento postup se týká toho, jak postupovat vytvoření evidence datových potřeb v úřadu a pro správu informací o datových potřebách a jejich realizaci dle úkolů ze Strategie správy dat VS"
...
Toto je kontrolní seznam a postup zejména využitelný pro datové architekty, správce dat a odborníky pro ICT v úřadech. Udává podrobnosti a návody, jak postupovat v jednotlivé oblasti.

Tento postup se týká toho, jak postupovat vytvoření evidence datových potřeb v úřadu a pro správu informací o datových potřebách a jejich realizaci dle úkolů ze Strategie správy dat VS. Úřad má mít dle SSD evidované svoje datové potřeby a má se starat o jejich realizaci.
...
Jde o realizaci Opatření 1.2.2 Stanovit a řídit datové potřeby v prioritních oblastech.

Evidence datových potřeb je interní evidenční nástroj, který
